...
<header>
    ...
    <div class="dropdown header-location">
        ...
        <div>
            <span class="selected-city">Выберите город</span>
        </div>
        <div class="dropdown-content">
            <form>
                <select size="1" onchange="updateCity(this)">
                    <option value="Минск"><?php echo $lang['Minsk']; ?></option>
                    <option value="Брест"><?php echo $lang['Brest']; ?></option>
                    <option value="Могилёв"><?php echo $lang['Mogilev']; ?></option>
                    <option value="Гомель"><?php echo $lang['Gomel']; ?></option>
                    <option value="Витебск"><?php echo $lang['Vitebsk']; ?></option>
                    <option value="Солигорск"><?php echo $lang['Soligorsk']; ?></option>
                    <option value="Мозырь"><?php echo $lang['Mozyr']; ?></option>
                    <option value="Борисов"><?php echo $lang['Borisov']; ?></option>
                </select>
            </form>
        </div>
    </div>
    ...
    <div class="rightside-sm-icons">
        <a><svg fill="#000" height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <path d="M113,145c-141.4,0-256,114.6-256,256s114.6,256,256,256s256-114.6,256-256S254.4,145,113,145z M169.5,357.6l-2.9,38.3h-39.3
        ...
        <a><svg fill="#000" width="800px" height="800px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a><svg fill="#000" width="800px" height="800px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        0 .327.029.352.104.044.119-.008.482-.821 1.583l-.363.479c-.737.966-.737 1.015.046 1.748z"/></svg></a>
    </div>
</header>
